...
這個專題是由其他兩位長照系夥伴發想，並由我進行形成視上的編寫。此專題目的於改善台灣政府的長照計畫，但十年長照計畫存在多種難以克服問題(如：長照服務申請過程繁瑣時間冗長、長照服務限制過多、照服員嚴重不足等問題)，使得長照服務在推廣上難上加難，因此我們設計一套使得現代人能更方便使用且更容易接受的長照整合系統。

以下為我們設計所的系統之主要架構

如下圖所示，由我們團隊提供資訊整合服務，使得需求端即受照顧者端得以享受方便的長照服務，也使家屬們能更放心出外工作。

![](https://i.imgur.com/w7ncmd3.png)
...
1. 雲端SQL伺服器(freesqldatabase.com)：{{< img src="https://i.imgur.com/C4LORMv.png" width="30%" height="30%" >}}

2. 遠端FTP伺服器(FileZilla)：{{< img src="https://i.imgur.com/MoFimyx.png" width="30%" height="30%" >}}

3. AndroidStudio開發軟體：{{< img src="https://i.imgur.com/25gN97G.png" width="30%" height="30%" >}}
...
{{< img src="https://i.imgur.com/ylsarI7.png" width="50%" height="50%" >}}

### 專題流程圖
{{< img src="https://i.imgur.com/9ZbUltM.png" width="50%" height="50%" >}}
...
SQL資料庫以MySQL與Microsoft SQL為兩大門派，其差異下表

|          | 性能 | Microsoft SQL |
| -------- | -------- | -------- |
| 價格     | 免費     | 付費     |
| 功能     | 比MsSQL弱     | 比MySQL優     |
| 平台相容性 | 可用於Unix，Windows，以及OS/2等平臺     | 只能windows上執行     |
| 可伸縮性、並行性     | 較強的伸縮性     | 並行實施模型不成熟，伸縮性有限     |
| 性能     | 支持多用戶操作，性能較高     | 多用戶時性能不佳     |


一開始在建立SQL時我是使用WAMP(Windows+Apache+MySQL+PHP)的方式，在本機電腦上建立SQL伺服器。但因為本機端網路的不方便，因此我想要使用雲端伺服器來進行存取，現今科技的雲端資料庫技術已經成熟了，目前主流伺服器為

亞馬遜雲服務（AWS）：![](https://i.imgur.com/RrftBqJ.png)


Google雲端平台（GCP）：![](https://i.imgur.com/c4RejGl.png)


微軟Azure：![](https://i.imgur.com/vkIwejq.png)
...
![](https://i.imgur.com/kx9A3wO.png)


2. 設定資料表內容：

![](https://i.imgur.com/ldwIT92.png)


3. 添加測試的資料：

![](https://i.imgur.com/hndel8C.png)


執行結果

![](https://i.imgur.com/ZFEw1cr.png)
...
| 系統登入中 | 登入成功畫面 |
| -------- | -------- |
| ![](https://i.imgur.com/YnlLnt7.png)   | ![](https://i.imgur.com/Rjj2Pco.png)     |
...
| 錄音畫面 | 上傳畫面 |
| -------- | -------- |
| ![](https://i.imgur.com/5ZuwcJ6.png)   | ![](https://i.imgur.com/IfkmpPf.png) |
